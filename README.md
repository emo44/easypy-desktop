...
- **No Vendor Lock-in** — output is readable `.py` files
- **Built on PySide6 (Qt for Python)**
- **Integrated Python Runtime** (no system setup required)
...
* 💬 **Questions & Community Help:** Need help using the app, want to ask a question, or share your projects? Please use **[GitHub Discussions](https://github.com/emo44/easypy-desktop/discussions)**. This is a user-to-user community space.
